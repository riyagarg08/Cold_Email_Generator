...
class Chain:
    ...
    def write_email(self, job,links):
        prompt_email = PromptTemplate.from_template(
            ...
            ### INSTRUCTION:
            You are Riya, a business development executive at AtliQ. AtliQ is an AI & Software Consulting
            company specializing in the seamless integration of business processes through automated tools.
            Over our experience, we have empowered numerous enterprises with tailored solutions,
            fostering process optimization, cost reduction, and heightened overall efficiency.
            ...
            {link_list}
            Remember you are Riya, BDE at AtliQ.
